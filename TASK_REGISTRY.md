...
| TASK-003B | Canonical Legal Object SQLAlchemy Models | Complete (pending review) | ORM definitions only; four models in `app/models/`; **not merged** — no migration in this task |

...
| TASK-006AC | Controlled Citation Execution Pre-Auth Review | Complete | APPROVED WITH REQUIRED REMEDIATION BEFORE 006AD |
| TASK-006AC1 | Controlled Citation Execution Remediation Package | Complete | AC-02/AC-03 remediated at spec level; await acceptance review |
| TASK-006AD | Controlled Citation Execution | Hold | **NOT AUTHORIZED** — requires 006AC1 acceptance + bounded spec |

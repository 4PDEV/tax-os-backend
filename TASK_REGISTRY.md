...
| TASK-007D | Retrieval Worker Skeleton | Complete | Dry-run only — [`TASKS/TASK-007D-RETRIEVAL-WORKER-SKELETON.md`](TASKS/TASK-007D-RETRIEVAL-WORKER-SKELETON.md); 759 tests |
| TASK-007D1 | Retrieval Execution Remediation | Planned | Required before controlled execution |

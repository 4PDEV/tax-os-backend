...
| TASK-006S | Parsing Worker Skeleton | Planned | Approved next; dry-run orchestration, `parser_run` lifecycle, trigger results; no `parsed_structure`/legal object/citation/answer |
